...
| Metric | Column used | Description | Proposed calculation | Importance | Status |
|---|---|---|---|---|---|
| Payment count | `stg_payments` | Number of payments processed | count of rows in `stg_payments` | low | Matched |
